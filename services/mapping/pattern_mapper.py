...
class PatternMapper:
    ...
    def map_fields(self, data: pd.DataFrame,
                 ...
                 manufacturer: str = None) -> Dict[str, str]:
        """
        ...
        mappings, _ = self._map_fields_internal(available_std_fields, input_columns, data)
    ...
    def _map_fields_internal(self, standard_fields: List[str], input_columns: List[str],
                 data: pd.DataFrame) -> Tuple[Dict[str, str], Dict[str, float]]:
        """
        Internal implementation of pattern-based field mapping
