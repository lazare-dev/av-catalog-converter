"""
Unit tests for the GPTClient with rate limiting and adaptive caching
"""
import pytest
import time
...
class TestGPTClient:
    """Tests for the GPTClient class with rate limiting and adaptive caching"""
